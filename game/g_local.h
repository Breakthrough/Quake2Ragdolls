...
#define FRAMETIME		ServerFrameTimeInSeconds
...
edict_t *CreateEntityEvent (byte ID, const entityParms_t &parms, vec3_t origin, vec3_t angles, bool freeAfterEvent = true);
void ConvertToEntityEvent (edict_t *entity, byte ID, const entityParms_t &parms, bool freeAfterEvent = true);

int IndexFromModelIndex (const String &modelIndex);
void Phys_SetBModelOnEntity (edict_t *entity, class btCompoundShape *shape);
class btCompoundShape *GetBModelShape (int index);
void G_SetClientAnimation (edict_t *ent, int anim, int animTime, bool force);
